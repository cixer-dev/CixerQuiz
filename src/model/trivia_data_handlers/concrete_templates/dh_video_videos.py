from src.model.trivia_data_handlers.concrete_templates.\
    brain import DataHandlerTemplate
from src.model.trivia_data_handlers.data_extractors.\
    answers.with_media import AnswersWithMedia
from src.model.trivia_data_handlers.data_extractors.\
    questions.with_media import QuestionsExtractorWithMedia


class DHVideoVideos(DataHandlerTemplate):
    """
    Extract, process, and provide data for one VIDEO_VIDEOS trivia level.
    """
    ...
    def __init__(self, level_path: str, duration: int) -> None:
        ...
        self.answers_dh = AnswersWithMedia(
            level_path, self.random_index
        )
        self.question = (
