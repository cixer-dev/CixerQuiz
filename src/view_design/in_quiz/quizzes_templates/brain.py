...
from src.view_design.custom_widgets.quiz_widgets.info_panels.\
    brain import InfoPanel
from src.view_design.page_design_toolkit import expander


class QuizLevelTemplate(QtW.QWidget):
    """Template panel for quiz level questions with video answers.
    ...
    def __init__(
        ...
        self.duration = self.data["quiz_duration"]
