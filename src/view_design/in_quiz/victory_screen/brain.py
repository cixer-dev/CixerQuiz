...
from src.view_design.in_quiz.victory_screen.victory_label import VictoryLabel
from src.view_design.in_quiz.victory_screen.victory_msg import VictoryMsg
...
class VictoryScreen(QtW.QWidget):
    ...
    def build_go_main_menu_btn(self):
        ...
        go_back_menu.pressed.connect(self.parent_widget.switch_to_quiz_menu)
        return go_back_menu
