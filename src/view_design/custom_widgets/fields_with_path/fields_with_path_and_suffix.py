...
from src.view_design.custom_widgets.file_system_buttons.\
    for_files_with_suffix import FilesystemForFilesWithSuffix


class FieldWithPathAndSuffix(FieldsWithPathTemplate):
    ...
    def __init__(
        ...
        self.open_filesystem_btn = FilesystemForFilesWithSuffix(
            self.parent_widget,
            self.suffix,
        )
