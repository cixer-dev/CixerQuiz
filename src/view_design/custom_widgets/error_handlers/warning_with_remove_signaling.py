...
from src.view_design.custom_widgets.push_buttons.cancel_button \
    import CancelButton
from src.view_design.custom_widgets.push_buttons.signalized_ok_button import \
    SignalizedOkButton

from src.model.translation_handler import _


class WarningWithRemoveSignaling(QtC.QObject):
    """QMessageBox displaying a warning message with red styling in the QSS \
