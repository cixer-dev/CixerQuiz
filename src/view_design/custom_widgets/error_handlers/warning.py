...
class WarningMessageBox(QtC.QObject):
    ...
    def __init__(
        ...
        self.msg_box = QtW.QMessageBox(self.parent_widget)
    ...
    def show(self):
        self.msg_box.setWindowTitle(self.title)
        self.msg_box.setText(self.message)
        self.msg_box.setIcon(QtW.QMessageBox.Icon.Warning)

        ok_button = OkButton()
        cancel_button = CancelButton()

        self.msg_box.addButton(
            ok_button,
