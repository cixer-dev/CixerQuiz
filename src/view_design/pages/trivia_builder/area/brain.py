...
from src.view_design.pages.trivia_builder.area.description_field \
    import DescriptionField
from src.view_design.pages.trivia_builder.area.duration_field \
...
from src.view_design.pages.trivia_builder.area.name_field \
    import NameField
from src.view_design.pages.trivia_builder.area.num_levels_field \
    import NumLevelsField


class TriviaBuilderArea(QScrollAreaWithVLayout):
    """QScrollAreaWithVLayout that aggregates trivia fields and emits \
    ...
    def _on_manifest_changed(self):
        self.trivia_manifest = {
            "is_valid_trivia": True,
            "num_levels": self.num_levels,
            "trivia_name": self.name,
            "trivia_description": self.description,
            "trivia_duration": int(self.duration) * 1000,
        }
        self.sgn_manifest_data_changed.emit(self.trivia_manifest)
